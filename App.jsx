...
const TOPICS = [
  { label: "Investing",  prompt: "Write an expert blog article about smart investing strategies for 2026. First line = compelling headline (no # symbol). Then use ## for section headings. At least 5 sections, 2-3 paragraphs each, 700+ words total." },
  { label: "Crypto",  prompt: "Write an expert blog article about cryptocurrency trends in 2026. First line = compelling headline (no # symbol). Then use ## for section headings. At least 5 sections, 2-3 paragraphs each, 700+ words total." },
  { label: "Budgeting",  prompt: "Write an expert blog article about budgeting and saving money in 2026. First line = compelling headline (no # symbol). Then use ## for section headings. At least 5 sections, 2-3 paragraphs each, 700+ words total." },
  { label: "Real Estate",  prompt: "Write an expert blog article about real estate investment in 2026. First line = compelling headline (no # symbol). Then use ## for section headings. At least 5 sections, 2-3 paragraphs each, 700+ words total." },
  { label: "Stocks",  prompt: "Write an expert blog article about stock market strategies for 2026. First line = compelling headline (no # symbol). Then use ## for section headings. At least 5 sections, 2-3 paragraphs each, 700+ words total." },
  { label: "Side Income",  prompt: "Write an expert blog article about building passive and side income in 2026. First line = compelling headline (no # symbol). Then use ## for section headings. At least 5 sections, 2-3 paragraphs each, 700+ words total." },
];
